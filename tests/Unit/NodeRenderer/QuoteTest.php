...
use Contentful\StructuredText\NodeRenderer\Quote;
...
class QuoteTest extends TestCase
{
     ...
     * @expectedExceptionMessage Trying to use node renderer "Contentful\StructuredText\NodeRenderer\Quote" to render unsupported node of class "Contentful\Tests\StructuredText\Implementation\Node".
     */
