...
use Contentful\StructuredText\NodeRenderer\OrderedList;
...
class OrderedListTest extends TestCase
{
     ...
     * @expectedExceptionMessage Trying to use node renderer "Contentful\StructuredText\NodeRenderer\OrderedList" to render unsupported node of class "Contentful\Tests\StructuredText\Implementation\Node".
     */
