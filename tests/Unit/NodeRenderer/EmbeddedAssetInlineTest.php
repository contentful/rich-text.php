...
class EmbeddedAssetInlineTest extends TestCase
{
     ...
     * @expectedExceptionMessage Trying to use node renderer "Contentful\RichText\NodeRenderer\EmbeddedAssetInline" to render unsupported node of class "Contentful\Tests\RichText\Implementation\Node".
     */
