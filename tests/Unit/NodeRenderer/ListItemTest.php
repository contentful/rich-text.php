...
use Contentful\StructuredText\NodeRenderer\ListItem;
...
class ListItemTest extends TestCase
{
     ...
     * @expectedExceptionMessage Trying to use node renderer "Contentful\StructuredText\NodeRenderer\ListItem" to render unsupported node of class "Contentful\Tests\StructuredText\Implementation\Node".
     */
